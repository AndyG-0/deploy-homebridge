    ...
    stages {
        ...
        stage('Deploy to k3s') {
            ...
            steps {
                    ...
                    sh 'export KUBECONFIG=/var/lib/jenkins/config && helm delete homebridge && sleep 10 && helm upgrade homebridge ./homebridge/ -i -n homebridge -f ./homebridge/values.yaml --recreate-pods'
            }
        }
    }
    post {
